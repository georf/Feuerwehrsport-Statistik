...
<div class="row">
    <div class="five columns">
        <h4>Verteilung der Wettkämpfe über das Jahr</h4>'.Chart::img('overview_month', array($_id, 'event')).'
    </div>
    <div class="five columns">
        <h4>Verteilung der Wettkämpfe über die Woche</h4>'.Chart::img('overview_week', array($_id, 'event')).'
    </div>
    <div class="five columns">
        <h4>Angebotene Disziplinen pro Wettkampf</h4>'.Chart::img('competitions_score_types', array($_id, 'event')).'
    </div>
</div>
<div class="row">
    <div class="five columns">
        <h4>Anzahl der Mannschaften pro Wettkampf</h4>'.Chart::img('competitions_team_counts', array($_id, 'event')).'
    </div>';

if ($individual > 0) {
    echo '
    <div class="five columns">
        <h4>Mannschaftswertungen der Einzeldisziplinen</h4>'.Chart::img('competitions_team_scores', array($_id, 'event')).'
    </div>
    <div class="five columns">
        <h4>Anzahl der Einzelstarter pro Wettkampf</h4>'.Chart::img('competitions_person_counts', array($_id, 'event')).'
    </div>';
}
echo '</div>
<h2>Disziplinen</h2>';
...
<div class="row hideshow" style="border:1px solid #BAE0F1">
    ...
    <div class="five columns">
        <table>
            ...
            <tr><th>Bestzeit</th><td>',FSS::time($best['time']),' s<br/>',Link::person($best['id'], 'full'),'<br/>',Link::competition($c['id'], gDate($c['date'])).' '.Link::place($c['place_id'], $c['place']).'</td></tr>
        </table>
    </div>
    <div class="five columns">
';
    ...
    if ($total > 0) {
        ...
        <div class="six columns">
            <table>
                ...
                <tr><th colspan="2">Bestzeit</th><td>',FSS::time($best['time']),' s<br/>',Link::team($best['team_id']),'<br/>',Link::competition($c['id'], gDate($c['date'])).' '.Link::place($c['place_id'], $c['place']).'</td></tr>';
