...
<div class="row">
    <div class="five columns">
        <h4>Verteilung der Wettkämpfe über das Jahr</h4>'.Chart::img('overview_month', array($_id, 'place')).'
    </div>
    <div class="five columns">
        <h4>Verteilung der Wettkämpfe über die Woche</h4>'.Chart::img('overview_week', array($_id, 'place')).'
    </div>
    <div class="five columns">
        <h4>Angebotene Disziplinen pro Wettkampf</h4>'.Chart::img('competitions_score_types', array($_id, 'place')).'
    </div>
</div>
<div class="row">
    <div class="five columns">
        <h4>Anzahl der Mannschaften pro Wettkampf</h4>'.Chart::img('competitions_team_counts', array($_id, 'place')).'
    </div>';

if ($individual > 0) {
    echo '
    <div class="five columns">
        <h4>Mannschaftswertungen der Einzeldisziplinen</h4>'.Chart::img('competitions_team_scores', array($_id, 'place')).'
    </div>
    <div class="five columns">
        <h4>Anzahl der Einzelstarter pro Wettkampf</h4>'.Chart::img('competitions_person_counts', array($_id, 'place')).'
    </div>';
}
echo '
</div>
