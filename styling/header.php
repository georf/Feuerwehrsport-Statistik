    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Weitere Statistiken <b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="/page/places.html">Orte</a></li>
              <li><a href="/page/events.html">Typen</a></li>
              ...
              <li><a href="#">Letzte Änderungen</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
