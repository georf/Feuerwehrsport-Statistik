...
<head>
	...
	<script type="text/javascript" src="js/FormWindow.js"></script>
	<script type="text/javascript" src="js/Login.js"></script>
</head>
<body>
<div class="container" id="header">
  <a href="?page=home">Startseite</a>
  <a href="?page=news">Neuigkeiten</a>
  <a href="?page=competitions">Wettkämpfe</a>
  <a href="?page=teams">Mannschaften</a>
  <a href="?page=places">Orte</a>
  <a href="?page=events">Events</a>
  <a href="?page=persons">Personen</a>
  <a href="?page=logs">Veränderungen</a>
</div>
