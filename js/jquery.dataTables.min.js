...
c),a.fnServerData.call(a.oInstance,a.sAjaxSource,c,function(c){var f=a.sAjaxDataProp!==""?S(a.sAjaxDataProp)(c):c;for(b=0;b<f.length;b++)J(a,f[b]);a.iInitDisplayStart=d;if(a.oFeatures.bSort)Q(a);else{a.aiDisplay=a.aiDisplayMaster.slice();A(a);z(a)}F(a,false);$(a,c)},a)):a.oFeatures.bServerSide||(F(a,!1),$(a))}}function $(a,b){a._bInitComplete=!0;C(a,"aoInitComplete","init",[a,b])}function oa(a){var b=j.defaults.oLanguage;!a.sEmptyTable&&(a.sZeroRecords&&"Keine Daten verfügbar"===b.sEmptyTable)&&
...
fnStateSave:function(e,i){this.oApi._fnCreateCookie(e.sCookiePrefix+e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": Klicken für aufsteigende Reihenfolge",sSortDescending:": Klicken für absteigende Reihenfolge"},oPaginate:{sFirst:"Erste",sLast:"Letzte",sNext:"Nächste",sPrevious:"Vorherige"},sEmptyTable:"Keine Daten verfügbar",
sInfo:"Zeige _START_ bis _END_ von _TOTAL_ Einträgen",sInfoEmpty:"Zeige 0 von 0 Einträgen",sInfoFiltered:"(gefiltert von insgesamt _MAX_ Einträgen)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Zeige _MENU_ Einträge",sLoadingRecords:"Laden...",sProcessing:"Arbeite...",sSearch:"Suche:",sUrl:"",sZeroRecords:"Keine passenden Einträge gefunden"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",
...
jQuery.extend( jQuery.fn.dataTableExt.oSort, {
    "score-time-asc": function(a, b) {
        var x = (a == "D") ? 999999 : a.replace( /,/, "." );
        var y = (b == "D") ? 999999 : b.replace( /,/, "." );
        x = parseFloat( x );
        y = parseFloat( y );
        return ((x < y) ? -1 : ((x > y) ?  1 : 0));
    },
    "score-time-desc": function(a,b) {
        var x = (a == "D") ? 999999 : a.replace( /,/, "." );
        var y = (b == "D") ? 999999 : b.replace( /,/, "." );
        x = parseFloat( x );
        y = parseFloat( y );
